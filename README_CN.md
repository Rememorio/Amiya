...
- 在 QQ / OneBot / Telegram / Discord / 企业微信等 AstrBot 已支持的平台里调用
  Codex。
- 用 `SOUL*.md` 文件定义人格，例如默认的 `SOUL-Amiya.md`、`SOUL-Eyjafjalla.md`
  或 `SOUL-Requiem.md`。
...
| 字段 | 推荐值 | 说明 |
| --- | --- | --- |
| `soul_file` | `SOUL-Amiya.md` | 内置 `SOUL-Amiya.md`、`SOUL-Eyjafjalla.md` 和 `SOUL-Requiem.md`。 |
...
SOUL 文件可以用可选 front matter 自定义内置回复：
